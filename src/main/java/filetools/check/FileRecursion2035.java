 ...
 *
 */
public class FileRecursion2035 {
	static LogOut logout = new LogOut("D:/insertbatch2018-06-17_35.txt");
	static long count = 0;
...
//					ImageTools.gif2jpg(file_1.getAbsolutePath(), file_1.getAbsolutePath().replaceAll(".gif", ".jpg"));
