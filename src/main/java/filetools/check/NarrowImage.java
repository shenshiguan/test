...
public class NarrowImage {
	...
	public static BufferedImage zoomImage(String src) {
		...
		try {
			...
			System.out.println("im.getWidth():"+width);
			
			//压缩计算
//			float resizeTimes = 0.3f;  /*这个参数是要转化成的倍数,如果是1就是转化成1倍*/
			float resizeTimes = (float)(800.00f/width);
			System.out.println( 800.00f/width);
//			float resizeTimes = 0.37f;
	 ...
	 public static void main(String[] args) {
		 ...
		 String inputFoler = "D:\\首都师范大学1\\首都师范大学(333)教育综合2012年真题\\2012212.jpg" ; 
         /*这儿填写你存放要缩小图片的文件夹全地址*/
		 String outputFolder = "D:\\首都师范大学1\\首都师范大学(333)教育综合2012年真题\\2012212.jpg";  
        /*这儿填写你转化后的图片存放的文件夹*/
